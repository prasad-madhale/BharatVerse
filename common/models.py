"""
Article data models shared by scrapper/ (generation) and backend/ (storage
and API responses) -- kept in one place so the two services can't drift
apart on what an "Article" looks like.
"""
